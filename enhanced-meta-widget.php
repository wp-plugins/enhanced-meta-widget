    ...
    $display_wplink				= $instance['wplink'] ? '1' : '0';
		...
		*/
		if (is_user_logged_in()) {
			...
			<?php 
			/*
			 * This section is for all users based upon logged in status and their roles/permissions
			*/
			if ($display_loginout) { ?>
      ...
      */
      ...
      <?php
			echo $after_widget;
			} //ends if to check if form display is set in options
		} //ends else statement to display log-in form
